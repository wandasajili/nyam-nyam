        ...
        <div class="container-fluid page-body-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="admin/menu">
                            <span class="menu-title"
                                style="color: #3E4B5B !important; font-weight: 100 !important;">Menu</span>
                            <i class="mdi mdi-table-large menu-icon"
                                style="color: #3E4B5B !important; font-weight: 100 !important;"></i>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin/message') }}">
                            <span class="menu-title"
                                style="color: #3E4B5B !important; font-weight: 100 !important;">Message</span>
                            <i class="mdi mdi-table-large menu-icon"
                                style="color: #3E4B5B !important; font-weight: 100 !important;"></i>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin/review') }}">
                            <span class="menu-title"
                                style="color: #3E4B5B !important; font-weight: 100 !important;">Review</span>
                            <i class="mdi mdi-table-large menu-icon"
                                style="color: #3E4B5B !important; font-weight: 100 !important;"></i>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin/team') }}">
                            <span class="menu-title"
                                style="color: #3E4B5B !important; font-weight: 100 !important;">Team</span>
                            <i class="mdi mdi-table-large menu-icon"
                                style="color: #3E4B5B !important; font-weight: 100 !important;"></i>
                        </a>
                    </li>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    @if (session('success'))
                        <div class="alert alert-success" role="alert" id="login-alert">{{ Auth::user()->name }}
                            successfully login</div>
                    @endif

                    <!-- Dashboard Cards -->
                    <div class="row">
                        <!-- Menu Card -->
                        <div class="col-md-4 stretch-card grid-margin" onclick="window.location.href='/admin/menu'"
                        ...
                        <div class="col-md-4 stretch-card grid-margin" onclick="window.location.href='/admin/message'"
                            style="cursor: pointer;">
                        ...
                        <!-- Weekly Orders Card -->
                        <div class="col-md-4 stretch-card grid-margin" onclick="window.location.href='admin/review'"
                            style="cursor: pointer;">
                        ...
                        <div class="col-md-4 stretch-card grid-margin" onclick="window.location.href='admin/team'"
                            style="cursor: pointer;">
                            <div class="card bg-gradient-success   card-img-holder text-white">
                                <div class="card-body">
                                    <img src="{{ asset('backend/assets/images/dashboard/circle.svg') }}"
