                  ...
                  <div class="card w-100">
                    <div class="card-body">
                      ...
                      <p class="card-review_text"> 
                        Add a review by filling out the form below  </p>
                        ...
                        <form action="{{ route('review.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Review</label>
                                <input type="text" name="review_text" class="form-control @error('review_text') is-invalid @enderror" value="{{ old('review_text') }}">
                                @error('review_text')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <a href="{{ url('review') }}" class="btn btn-light">Cancel</a>
                        </form>
