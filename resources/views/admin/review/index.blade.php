                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row align-items-center mb-3">
                      ...
                      <div class="col-auto">
                        <a href="/admin/review/create" class="btn btn-sm btn-primary">Add Item</a>
                      </div>
                    </div>
                      ...
                      <table class="table table-responsive-stack">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td data-label="Review" style="max-width: 250px; white-space:normal; word-wrap:break-word">{{ $review->review_text }}</td>
                            <td data-label="Updated At">{{ $review->updated_at }}</td>
                            <td class="td-actions" data-label="Action">
                              <form action="{{ route('review.destroy', $review->id) }}" method="POST" class="action-form">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('review.edit', $review->id) }}" class="btn btn-sm btn-primary">Update</a>
