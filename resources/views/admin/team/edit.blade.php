                  ...
                  <div class="card w-100">
                    <div class="card-body">
                      ...
                      <p class="card-description"> 
                        Edit a team by changing out the form below  </p>
                        ...
                        <form action="{{ route('team.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="socialmedia" class="form-control @error('socialmedia') is-invalid @enderror" value="{{ $team->socialmedia }}">
                                @error('socialmedia')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label>Image</label>
                                <input type="file" name="image" value="{{ $team->image }}" class="form-control @error('image') is-invalid @enderror">
                                @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <a href="{{ url('admin/team') }}" class="btn btn-light">Cancel</a>
                        </form>
