    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Purwakarta</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>081327888592</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>nyamnyamchips@gmail.com</p>
                <div class="d-flex pt-2">
                    <a class="btn btn-outline-light btn-social" href="https://wa.me/62881024548319" target="_blank">
                        <i class="fab fa-whatsapp"></i>
                    </a>
                    <a class="btn btn-outline-light btn-social" href="https://www.instagram.com/anaranyamnyam/"
                        target="_blank">
            ...
            <div class="col-lg-3 col-md-6">
                <img src="{{ asset('img/nyum.png') }}" width="200px" alt="">
            </div>
        </div>
    </div>
    <div class="container">
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Nyam-Nyam</a>
